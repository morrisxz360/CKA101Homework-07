...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td><h3>The Star: Order</h3>
				<h4>( MVC )</h4></td>
		</tr>
	</table>

	<p>This is the Home page for The Star: Order</p>
	...
	<ul>
		...
		<li>
			<FORM METHOD="post" ACTION="order.do">
				<b>輸入訂單編號 (如 1):</b> <input type="text" name="orderId"> <input
		...
		<li>
			<FORM METHOD="post" ACTION="order.do">
				<b>選擇訂單編號:</b> <select size="1" name="orderId">
